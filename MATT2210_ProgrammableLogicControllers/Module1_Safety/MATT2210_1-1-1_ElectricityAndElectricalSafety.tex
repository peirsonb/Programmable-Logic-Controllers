...
% 		\begin{figure}
%             \centering
%             \includegraphics[width=0.75\columnwidth, alt={A double electric arc from a Tesla coil, electrical experience at the science festival in October 2016 in Le Teil d'Ardèche}]{Arc_electrique_double}
...
% %     \begin{figure}
% %         \centering
% %         \animategraphics[autoplay, loop, width=\columnwidth]{10}{images/current/current-}{0}{20}
% %         \caption*{The \textbf{flow rate} (speed) of electric charges through a conductor}
% %     \end{figure}
% % \end{frame}
...
% %         \centering
% %         \animategraphics[autoplay, loop, width=\columnwidth]{10}{images/current/current-}{0}{20}
% %         \caption*{One \textbf{ampere} is 6.24 $\times$ 10\textsuperscript{18} electrons (one coloumb of charge) flowing past a given point in one second}
% %     \end{figure}
% % \end{frame}
...
%     \begin{figure}
%         \centering
%         %\includegraphics[width=0.75\columnwidth, page=25, alt={}]{Circuits1-1-1ElectricityTikz.pdf}
%         \input{../../assets/diagrams/ACExamplePlot.tex}\\
%         {\footnotesize \textbf{Alternating current} is an electric current that reverses polarity at regular intervals\par}
%     \end{figure}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.5\columnwidth, page=2, alt={}]{Circuits3-2-1AlternatingCurrentTikz.pdf}
%         \caption*{As the \textbf{alternator's} coil spins inside the magnetic field the coil cuts the field in different directions, leading to a reverse in polarity}
%     \end{figure}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.5\columnwidth, page=1, alt={}]{Circuits3-2-1AlternatingCurrentTikz.pdf}
%         \caption*{\textbf{Frequency} is defined as the number of cycles in one second (Hertz, Hz)}
%     \end{figure}
% \end{frame}
...
%         \centering
%         \includegraphics[width=0.5\columnwidth, page=1, alt={}]{Circuits3-2-1AlternatingCurrentTikz.pdf}
%         \caption*{The standard frequency for AC in the US is 60 Hz}
%     \end{figure}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.5\columnwidth, page=23, alt={}]{Circuits1-1-1ElectricityTikz.pdf}
%         \caption*{\textbf{Direct current} is an electric current that flows in one direction only (maintains polarity)}
%     \end{figure}
% \end{frame}

% \begin{frame}
%     \frametitle{Rectifier}
%     \begin{figure}
%         \centering
%         \includegraphics[width=0.5\columnwidth, alt={}]{rectifier}
%         \caption*{A \textbf{bridge rectifier} is commonly used in controls applications to convert AC to DC}
%     \end{figure}
% \end{frame}
...
%     		\begin{figure}
%     			\centering
%     			\includegraphics[width=\columnwidth]{rectifier1}
%     		\end{figure}
%     	\end{column}
%     	\begin{column}{0.5\linewidth}
%     		\begin{figure}
%     			\centering
%     			\includegraphics[width=\columnwidth]{rectifier2}
%     		\end{figure}
%     	\end{column}
% 	\end{columns}
%     \begin{center}
%         As the polarity of the AC changes the rectifier forces the output to the same polarity
%     \end{center}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \input{../../assets/plots/FullWaveRectifier_Plot.tex}\\
%         {\footnotesize The rectifier redirects the current so the output is always the same polarity but it \emph{does not} affect the voltage value\par}
%     \end{figure}
% \end{frame}
...
%         \centering
%         \input{../../assets/plots/FullWaveRectifier_Plot.tex}\\
%         {\footnotesize The resulting wave form is DC, but not very useful DC\par}
%     \end{figure}
% \end{frame}

% \begin{frame}
%     \frametitle{Rectifier Smoothing}
%     \begin{figure}
%         \centering
%         \includegraphics[width=\columnwidth, page=26, alt={}]{MATT1150Ch30PowerSuppliesTikz.pdf}
%         \caption*{Smoothing capacitors maintain the voltage level between cycles which helps keep the DC at a more consistent value}
%     \end{figure}
% \end{frame}
...
%     \begin{figure}
%         \centering
%         \includegraphics[width=\columnwidth, page=27, alt={}]{MATT1150Ch30PowerSuppliesTikz.pdf}
%         \caption*{Smoothing capacitors maintain the voltage level between cycles which helps keep the DC at a more consistent value}
%     \end{figure}
% \end{frame}
