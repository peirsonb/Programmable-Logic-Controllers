...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item England's climate is pretty terrible for growing cotton--plus, they have limited space
...
\begin{frame}
    \frametitle{The Second Industrial Revolution}

    \begin{columns}
        \begin{column}{0.48\linewidth}
            \begin{itemize}
                \item 1870-1914ish
                \item Replacement of central steam power with distributed electricity
                \item The moving assmebly line (1913)
            \end{itemize}
        \end{column}
        \begin{column}{0.48\linewidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.75\columnwidth, alt={Black and white historical photograph showing factory workers lined up along a assembly conveyor belt. The men wear flat caps, knit hats, and aprons while assembling mechanical wheel components using tools and parts stored in metal bins below the track. Overarching machinery and industrial factory ceilings fill the background.}]{Ford_assembly_line_-_1913.jpg}

                {\tiny \textbf{Attribution:} Unknown, Public domain, via \href{https://commons.wikimedia.org/wiki/File:Ford_assembly_line_-_1913.jpg}{Wikimedia Commons}\par}
            \end{figure}            
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    \frametitle{The Third Industrial Revolution}

    \begin{itemize}
        \item[1968] GM issues specification for ``Standard Machine Controller''
        \begin{itemize}
            \item Solid-state components
            \item 16 inputs, expandable to 256
            \item 16 outputs, expandable to 128
            \item Easy programming/reprogramming
            \item 1kB memory, expandable to 4kB
        \end{itemize}
    \end{itemize}
\end{frame}

\begin{frame}
    \frametitle{The First Controller}

    \begin{columns}
        \begin{column}{0.48\linewidth}
            \begin{itemize}
                \item Dick Morley - Bedford Associates
                \item \textbf{Mo}dular \textbf{Di}gital \textbf{Con}troller 084
                \item Reduced cycle time at General Motors by 60\%
                \item So successful Bedford Associates renamed themselves to Modicon
            \end{itemize}
        \end{column}
        \begin{column}{0.48\linewidth}
            \begin{figure}
                \centering
                \includegraphics[width=0.75\columnwidth, alt={A patent schematic diagram showing the programming panel interface for a Modicon 084 controller, featuring labeled control buttons, a numeric keypad, symbol selection keys, and a central display screen illustrating a ladder logic circuit diagram with relay contacts and a coil.}]{Patent3944984_Fig6_ProgrammingInterface.png}

                {\tiny Modicon CPU Programming Interface. Source: U.S. Patent 3,944,984 (Richard E. Morley, inventor). Public Domain.\par}
            \end{figure}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    \frametitle{The First PLC}

    \begin{itemize}
        \item Success gets copied
        \item In 1974 Allen-Bradley released their Bulletin 1774 Programmable Logic Controller--the first time PLC was used
        \item By 1986 the 5$^{th}$ revision, the PLC-5, had 450,000 installations worldwide
    \end{itemize}
\end{frame}

\begin{frame}
    \frametitle{The Fourth Industrial Revolution}

    \begin{itemize}
        \item[2011] Defined by interconnectivity--\emph{Smart Factories}
        \item Sensors are no longer islands--everything is connected
        \item \emph{Industrial Internet of Things (IIoT)}
        \item IIoT data is used for \emph{predictive} maintenance--massive efficiency gains
    \end{itemize}
\end{frame}

\begin{frame}
    \frametitle{The Fifth Industrial Revolution}

    \begin{itemize}
        \item We're still \emph{very} early in this one
        \item Humans are collaborating with automation more than ever
        \item Rather than identical, mass-produced goods automation can be steered by a human designer in real-time
        \item Modern automation efficiency with human creativity
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\linewidth}
            \begin{figure}
                \centering
                \includegraphics[width=\columnwidth, alt={An Allen-Bradley SLC 150 programmable logic controller unit sits on a wooden workbench next to its handheld pocket programmer terminal, which is plugged into the main unit with a gray cable.}]{AllenBradleyNYCCT1154a.jpg}

                {\tiny \textbf{Attribution:} GK tramrunner229, \href{https://creativecommons.org/licenses/by-sa/3.0}{CC BY-SA 3.0}, via \href{https://commons.wikimedia.org/wiki/File:AllenBradleyNYCCT1154a.jpg}{Wikimedia Commons}\par}
        ...
        \begin{column}{0.48\linewidth}
            \begin{figure}
                ...
                \resizebox{0.75\columnwidth}{!}{
                    \input{../../assets/diagrams/PLC_SinkingInput.tex}
                }
            \end{figure}
            ...
            \begin{figure}
                \centering
                \resizebox{0.75\columnwidth}{!}{
                    \input{../../assets/diagrams/PLC_SinkingOutput.tex}
                }
            \end{figure}
        \end{column}
    \end{columns}    
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\linewidth}
            \begin{figure}
                \centering
                \resizebox{0.75\columnwidth}{!}{
                    \input{../../assets/diagrams/PLC_SourcingInput.tex}
                }
            \end{figure}
            ...
            \begin{figure}
                \centering
                \resizebox{0.75\columnwidth}{!}{
                    \input{../../assets/diagrams/PLC_SourcingOutput.tex}
                }
            \end{figure}
        \end{column}
    \end{columns}    
        ...
        \begin{column}{0.48\linewidth}
            \begin{figure}
                ...
                \resizebox{0.875\columnwidth}{!}{
                    \input{../../assets/diagrams/PLC_InputCommon.tex}
                }
            \end{figure}
        \end{column}
    \end{columns}
    ...
    \begin{columns}
        ...
        \begin{column}{0.48\linewidth}
            \begin{figure}
                \centering
                \resizebox{0.875\columnwidth}{!}{
                    \input{../../assets/diagrams/PLC_OutputCommon.tex}
                }
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \resizebox{0.375\linewidth}{!}{
            \input{../../assets/diagrams/PLC_OutputCommon_Fused.tex}
        }
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \resizebox{0.375\linewidth}{!}{
            \input{../../assets/diagrams/PLC_ScanCycle.tex}
        }
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \resizebox{0.75\linewidth}{!}{
            \input{../../assets/diagrams/PLC_ScanCycle_Example1.tex}
        }
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \resizebox{0.75\linewidth}{!}{
            \input{../../assets/diagrams/PLC_ScanCycle_Example2.tex}
        }
    \end{figure}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \resizebox{0.75\linewidth}{!}{
            \input{../../assets/diagrams/PLC_ScanCycle_Example5.tex}
        }
    \end{figure}
