\begin{circuitikz}[
    ...
    alt={Ladder logic diagram containing three rungs spanning between two vertical power rails. The top rung consists of a normally open contact labeled StartPB in series with an output coil labeled GreenLT. The middle rung consists of a normally closed contact labeled StartPB in series with an output coil labeled YellowLT. The bottom rung consists of two normally open contacts in series labeled StartPB and GreenLT, leading to an output coil labeled Blink.}
    ]
    ...
    \begin{pgfonlayer}{main}
        ...
        \begin{scope}[
            ...
            % Rung 2
            %=================================================================
            \draw (C-0-1) to[vC,l={StartPB}] (C-1-1) -- (C-4-1) to[esource,l={YellowLT}] (C-5-1);

            %=================================================================
            % Rung 3
            %=================================================================
            \draw (C-0-2) to[C,l={StartPB}] (C-1-2) to[C,l={GreenLT}] (C-2-2) -- (C-4-2) to[esource,l={Blink}] (C-5-2);
