\begin{circuitikz}[
    ...
    \begin{pgfonlayer}{main}
        ...
        \begin{scope}[
            ...
            % Rung 1
            %=================================================================
            \draw (C-0-0) to[vC, l={\texttt{Timer.DN}}] (C-1-0) -- (C-3-0) pic (TON) {TON};
            \draw (TON-OUT) -- (C-5-0);

            \node[anchor=south] at (TON-TOP) {TON};
            \node[anchor=north] at (TON-TOP) {\texttt{Timer}};
            \node[anchor=west] at (TON-PRE) {2000};
            \node[anchor=west] at (TON-ACC) {2003};
    ...
    \begin{pgfonlayer}{bg}
        ...
        \begin{scope}[
            ...
            \draw (TON-EN1) -- (TON-EN2);

            \draw (TON-DN1) -- (TON-DN2);
