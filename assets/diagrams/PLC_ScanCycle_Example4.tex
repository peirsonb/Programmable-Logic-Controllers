\begin{circuitikz}[
        ...
        %>=latex,
        alt={A ladder logic diagram bounded by two vertical power rails, showing full power flow across the second rung after LT2 becomes true. The top rung remains unhighlighted and inactive, with Start PB open and output coil LT1 off. The left power rail and both parallel paths on the second rung are highlighted in green, indicating power flowing through both the Manual PB contact and the seal-in contact labeled LT2. These paths merge to energize the output coil LT2 on the right rail.}
    ]
