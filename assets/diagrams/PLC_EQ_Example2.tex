\begin{circuitikz}[
    ...
    \begin{pgfonlayer}{main}
        ...
        \begin{scope}[
            ...
            % Rung 1
            %=================================================================
            \draw (C-0-0) -- ++(0.5,0) pic (EQ) {SrcAB};
            \draw (EQ-OUT) -- (C-4-0) to[esource, l={OpenDoor}] (C-5-0);

            % EQ box labels
            \node[anchor=south] at (EQ-TOP) {EQ};
            \node[anchor=west] at (EQ-SRCA) {PartCount};
            \node[anchor=west] at (EQ-AVAL) {11};
            \node[anchor=west] at (EQ-SRCB) {BatchLimit};
            \node[anchor=west] at (EQ-BVAL) {10};
