\begin{circuitikz}[
        ...
        %>=latex,
        alt={A ladder logic diagram bounded by two vertical power rails, illustrating active power flow immediately after Manual PB is pressed. The top rung is unhighlighted and inactive, with Start PB released and output coil LT1 off. The left vertical power rail and the primary horizontal line of the second rung are highlighted in green, indicating power flow from the left rail through the closed Manual PB contact to energize output coil LT2. The parallel branch below it, containing contact LT2, remains unhighlighted during this initial scan.}
    ]
