\begin{circuitikz}[
    ...
    \begin{pgfonlayer}{main}
        ...
        (C-0-0)
        to[C, color=BakerBlack, l={{\small StartPB}}] (C-1-0)
        -- (C-4-0)
        to[esource, color=BakerBlack, l={{\small StartPB}}] (C-5-0);

        \draw[
            BakerBlack
        ]
        (C-0-1)
        to[C, color=BakerBlack, l={{\small TimerPB}}] (C-1-1)
        -- (C-3-1);

        \path (C-3-1) pic (T1) {TON};
